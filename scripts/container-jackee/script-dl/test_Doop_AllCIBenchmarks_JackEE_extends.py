...
# 1. run jackee benchmarks with web-application-original.dl
for name in jackee_names:
    cmd = '/home/pldi2020/runSingleCIOriginalDoopBench.sh ' + name
    print(cmd)
    os.system(cmd)

# 2. run extends benchmarks with web-application-original.dl
