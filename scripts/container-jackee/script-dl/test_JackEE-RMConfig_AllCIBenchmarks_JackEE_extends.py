...
# 1. run jackee benchmarks with rules-web-application-remove-config.dl
for name in jackee_names:
    cmd = '/home/pldi2020/runSingleCIBench-remove-config.sh ' + name
    print(cmd)
    os.system(cmd)

# 2. run extends benchmarks with rules-web-application-remove-config.dl
