...
# 1. run jackee benchmarks with mhn0202-withoutJackEETestcase.dl
for name in jackee_names:
    cmd = '/home/pldi2020/runSingleCIBench-mhn0202-withoutJackEETestcase.sh ' + name
    print(cmd)
    os.system(cmd)

# 2. run extends benchmarks with mhn0202-withoutJackEETestcase.dl
