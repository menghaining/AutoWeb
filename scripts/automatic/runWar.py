...
def run(webapp_name, testcases_dir, tomcat_dir,answer_dir, deployTime, singleReqTime):
    ...
    while(os.path.exists(os.path.join(testcases_dir,str(id)))):
        ...
        time.sleep(15) # actually copy will block until complete
...
if __name__ == '__main__':
    ...
    run(webapp_name, testcases_dir, tomcat_dir,answer_dir, 50, 3)