...
public class LogParser {
	...
	public LogParser(String original_log, GraphBuilder builder) {
		this.filePath = original_log;
		this.builder = builder;

		unreachableRoots = builder.getAllUnreachableEntryPoints();
...
//		}
	 ...
	 */
	public HashMap<Integer, ArrayList<String>> getId2group_all() {
